from brownie import accounts, config, network, MockV3Aggregator, LinkToken, VRFCoordinatorMock, MockOracle, Contract, interface
...
contract_to_mock = {"eth_usd_price_feed": MockV3Aggregator, "vrf_coordinator": VRFCoordinatorMock, "link_token": LinkToken, "oracle": MockOracle}
